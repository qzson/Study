...
''' 1. 데이터 '''
x_train, x_test, y_train, y_test = np.load('./project/mini/data/multi_image_data2.npy')
...
model.add(Conv2D(32, (2,2), activation='relu', padding='same', input_shape=x_train.shape[1:]))
