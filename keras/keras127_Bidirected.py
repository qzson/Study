...
'''
날씨를 가지고 거꾸로 맞출 수도 있다 그그 전날
데이터 연산이 2배, 방향성도 거꾸로지만 순서대로 될 것
시계열 작업을 2번 하는 것 그것이 bidirected
lstm 등 시계열 쪽에서 래핑을 해버린다
lstm을 래핑하면, 양방향으로 먹혀주겠다 라는 뜻
기본적인 lstm을 더 강력하게 만들어버린다
'''
